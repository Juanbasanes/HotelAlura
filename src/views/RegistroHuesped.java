...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int idReserva) {
		...
		txtNacionalidad.setModel(new DefaultComboBoxModel<String>(new String[] {
				...
				"finlandés-finlandesa", "francés-francesa", "galés-galesa", "griego-griega", "guatemalteco-guatemalteca",
	...
	private void guardarHuesped() {
		...
		if (fechaNacimiento == null || nombre.isEmpty() || apellido.isEmpty() || telefono.isEmpty()) {
			JOptionPane.showMessageDialog(this, "Debes llenar todos los campos.");
		} else if (fechaNacimiento.after(new Date())) {
			JOptionPane.showMessageDialog(this, "La fecha de nacimiento debe ser anterior a la fecha actual.");
		} else if (telefono.length() < 7) {
			JOptionPane.showMessageDialog(this, "El número de teléfono debe tener al menos 7 dígitos.");
		} else {
			int nreserva = Integer.parseInt(txtNreserva.getText());
			Huespedes huespedes = new Huespedes(nombre, apellido, new java.sql.Date(fechaNacimiento.getTime()), txtNacionalidad.getSelectedItem().toString(), telefono, nreserva);
